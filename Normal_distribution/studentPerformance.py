...
print(len(list_of_data_within_1_std_deviation)*100.0/len(data))
print(len(list_of_data_within_2_std_deviation)*100.0/len(data))
print(len(list_of_data_within_3_std_deviation)*100.0/len(data))
